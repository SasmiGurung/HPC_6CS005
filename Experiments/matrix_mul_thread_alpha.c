/****************************************************************************
  Compile with:
    ...
    cc matrix_mul_thread_alpha.c -o matrix_mul_thread_alpha -lrt -pthread 
...
#define MAT1_ROW 1024
#define MAT1_COL 1024 // matrix multiplication: mxn nxp (column of 1st matrix should be same as row of second matrix) 
#define MAT2_COL 1024
...
void *multiply_matrix(arguments_t *args){
    // for(int x=args->start; x<MAT1_ROW; x+=args->stride){
